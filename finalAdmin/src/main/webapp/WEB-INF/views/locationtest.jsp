...
<body>
	...
	<div style="display: inline-block; height: 50px;">
		...
		<input type="button" id="addr_btn"
			onclick="sample2_execDaumPostcode()" value="우편번호 찾기">
		<!-- </span> -->
	</div>

	<span class="box int_addr2"> <input type="text" class="int"
		id="sample2_address" name="address" readonly>
	</span>
	...
	<span class="box int_addr2"> <input type="text" class="int"
		id="sample2_detailAddress" name="detail">
	</span>
	...
	<!-- JOIN BTN-->
	<div class="btn_area">
		<button type="button" class="btn" id="enroll_btn"
			onclick="modify(${vo.u_idx});">
			<span>수정</span>
		</button>
		<button type="button" class="btn" id="revoke_btn"
			onclick="location.href='../mainpage/list.do'">
			<span>취소</span>
		</button>
	</div>
